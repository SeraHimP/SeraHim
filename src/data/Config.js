...
export const CONFIG = {
  ...
  groundTrace: {
    puddle: {
      ...
      // 归一化出一个 0~1 的尺寸系数，乘进最终减速里：bigPuddleRadius 是"多大
      // 算满档"的参照半径（取一个新水洼的最大子圆半径 subRadiusMax 的约 3 倍，
      // 大致对应"合并了两三片"的连片水洼），minSizeFactor 是新生小水洼（还没来得
      // 及合并）的下限系数，不让它掉到几乎没有减速。
      sizeSlowRefRadius: 260,  // 水洼外接半径达到这个值，尺寸系数封顶=1
