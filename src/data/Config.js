export const CONFIG = {
  ...
  ui: {
    ...
    rangeRing: {
      ...
      // 用户反馈"射程圈也是突然一下就出来了"：50→10 只有 40px 的过渡带，
      // 小兵走过这 40px 只要不到半秒，观感上就是"啪"地出现。放宽到 220→30（190px 带），
      // 敌人还在老远就开始若隐若现，走近才逐渐实起来。
      fadeOuter: 220,       // 射程 + 这么多：开始渐显（0%）
      fadeInner: 30,        // 射程 + 这么多：完全显示（100%）
