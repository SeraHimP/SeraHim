...
export const CONFIG = {
  ...
  ui: {
    ...
    groundTraceFx: {
      ...
      maxTrailPoints: 150,   // 雪痕点的实例池上限
      alpha: 0.45,
      puddleColor: 0x5b8fb0, // 水色，偏冷偏灰（不是鲜艳的蓝，贴在地面上不能太跳）
      trailColor: 0xdbe9f4,  // 雪痕色，浅冷白
    },
    // ==================== v47：单位的昼夜染色 ====================
  ...
  groundTrace: {
    puddle: {
      ...
      subRadiusMin: 30, subRadiusMax: 70,   // 子圆半径区间
      ...
      respawnIntervalSec: 2.5, // 触发条件满足时，每隔多久尝试补一个新水洼（直到数量达标）
      slowPct: -25,          // 站在水洼里的移速百分比修正（乘以该水洼当前 strength）
    },
    snowTrail: {
      minTierScale: 0.25,   // 至少这个天气档位系数（有限档起）才会留下痕迹
      sampleIntervalSec: 0.4, // 移动中的单位每隔多久在身后留一个痕迹点
      minMoveDistPx: 8,       // 与上一个痕迹点的距离小于这个值就不重复落点（避免原地堆叠）
      segmentRadius: 26,      // 每个痕迹点的半径
      lifetimeSec: 10,        // 单个痕迹点的存活时长（之后自然消失）
      speedPct: 20,           // 站在雪痕范围内的移速百分比加成
    },
  },
