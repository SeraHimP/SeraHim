...
export const EDITOR_PAGES_ENTITY = {
  ...
  _SKILLS_BY_TIER: {
    ...
    hq_tower:   ['passive_hq_fortify', 'passive_hq_bulwark', 'passive_growth_hq', 'passive_overload',
  ...
  _TIER_DEFAULT_SKILLS: {
    ...
    hq_tower:   ['passive_growth_hq', 'passive_hq_fortify', 'passive_hq_bulwark', 'passive_overload'],
